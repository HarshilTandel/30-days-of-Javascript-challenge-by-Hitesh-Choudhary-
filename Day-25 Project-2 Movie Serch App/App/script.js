...
async function loadPopularMovies() {
    try {
        ...
        popularMoviesGrid.innerHTML = '<p>There was an error fetching the popular movies. Please try again later.</p>';
    }
}
...
async function loadTrendingMovies() {
    try {
        ...
        trendingMoviesGrid.innerHTML = '<p>There was an error fetching the trending movies. Please try again later.</p>';
    }
}
...
async function searchMovies(query) {
    try {
        ...
        searchResultsGrid.innerHTML = '<p>An error occurred while searching for movies. Please try again later.</p>';
    }
}
